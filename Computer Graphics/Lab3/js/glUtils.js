...
function setMatrixUniforms(gContext) {
    ...
    gl.uniform3fv(diffLight, new Float32Array([0.75164, 0.60648, 0.22648]));
		...
		//Send max and min y values to shader program
		var minY = gl.getUniformLocation(GC.shaderProgram, "minY");
		gl.uniform1f(minY, GC.mesh.model.minY);
		var maxY = gl.getUniformLocation(GC.shaderProgram, "maxY");
		gl.uniform1f(maxY, GC.mesh.model.maxY);
}
