...
#  Assignment 7
#
#  'R' is the radial distance from the center of the Earth to the satellite
#  'theta' is the degree of rotation from the polar axis
#  'alpha' is the inclination (slope) of the direction with the polar axis
#  'e' is the eccentricity, which should be non-negative, of the real satellite orbit
#  'C' is the trajectory's center of curvature
...
#  This function builds the system of equations
def F(x):
