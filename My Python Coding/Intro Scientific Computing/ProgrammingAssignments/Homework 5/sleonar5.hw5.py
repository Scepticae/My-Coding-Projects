...
# Program takes x and y data and interpolates that data using
# the cubic spline method and displays that data in tables
...
# Generates curvatures for smoothness
...
for Re in Re_array:
	...
	# Use this print statement in your loop to display the interpolated data
